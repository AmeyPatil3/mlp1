...
export const MoodIcon: React.FC<{ mood: string, className?: string }> = ({ mood, className }) => {
    ...
    return <span className={className} role="img" aria-label={mood}>{icons[mood] || icons.Unknown}</span>;
};
